...
async function verify() {
  ...
  const baseUrl = "https://startschoolbe-1-toq0.onrender.com/api"; // Assuming default port from index.ts if not specified, but let's try to find it.
