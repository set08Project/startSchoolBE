...
function makeRunsFromHtml(html) {
...
function makeParagraph(runsXml) {
    return `<w:p><w:pPr><w:spacing w:after="200"/></w:pPr>${runsXml}</w:p>`;
}
function buildBody(questions) {
...
function buildDocumentXml(questions) {
...
function generateDocxBuffer(questions) {
