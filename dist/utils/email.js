...
exports.verifySchoolFees =
  exports.changeTokenEmail =
  exports.addMemberEmail =
  exports.hospitalVerifiedEmail =
...
const url = "https://just-next.web.app";
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const html = yield ejs_1.default.renderFile(myPath, {
        link: devURL,
        tokenCode:
          user === null || user === void 0 ? void 0 : user.enrollmentID,
...
const hospitalVerifiedEmail = (user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const accessToken = (yield oAuth.getAccessToken()).token;
      const transporter = nodemailer_1.default.createTransport({
      ...
      const myPath = path_1.default.join(
        __dirname,
        "../views/hospitalCreated.ejs"
      );
      const html = yield ejs_1.default.renderFile(myPath, {
        link: devURL,
        token: user.token,
...
const addMemberEmail = (member, getUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const accessToken = (yield oAuth.getAccessToken()).token;
      const transporter = nodemailer_1.default.createTransport({
...
const changeTokenEmail = (getUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const accessToken = (yield oAuth.getAccessToken()).token;
      const transporter = nodemailer_1.default.createTransport({
...
const verifySchoolFees = (user, term) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const accessToken = (yield oAuth.getAccessToken()).token;
      const transporter = nodemailer_1.default.createTransport({
